...
cXarea6 <- function() {
  ...
  canvasXpress(
    data=y,
    filterData=list(list("guess", "false", "different", "ARRAY(0x147b66f28)")),
    graphOrientation="vertical",
    graphType="Area",
    lineType="spline",
    smpTextRotate=90,
...
cXarea7 <- function() {
  ...
  canvasXpress(
    data=y,
    filterData=list(list("guess", "false", "exact", "ARRAY(0x147b67390)")),
    graphOrientation="vertical",
    graphType="Area",
    lineType="spline",
    smpTextRotate=90,
...
cXarea9 <- function() {
  ...
  canvasXpress(
    ...
    varAnnot=z,
    colorBy="Series",
    filterData=list(list("guess", "Series", "not like", "ARRAY(0x1478ab830)")),
    graphType="Area",
    lineType="spline"
  )
}
