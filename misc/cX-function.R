...
cXarea6 <- function() {
  ...
  canvasXpress(
    data=y,
    colorScheme="Behance",
    filterData=list(list("guess", "false", "different", "ARRAY(0x13f4c6490)")),
    graphOrientation="vertical",
    graphType="Area",
    lineType="spline",
    objectColorTransparency=0.7,
...
cXarea7 <- function() {
  ...
  canvasXpress(
    ...
    areaType="stacked",
    colorScheme="LastAirBenderWater",
    filterData=list(list("guess", "false", "exact", "ARRAY(0x13f522a28)")),
    graphOrientation="vertical",
    graphType="Area",
    lineType="spline",
    smpTextRotate=90,
...
cXarea9 <- function() {
  ...
  canvasXpress(
    ...
    colorBy="Series",
    colorScheme="GameOfThronesStannis",
    filterData=list(list("guess", "Series", "not like", "ARRAY(0x13f523340)")),
    graphType="Area",
    legendColumns=3,
    legendPosition="top",
    lineType="spline",
