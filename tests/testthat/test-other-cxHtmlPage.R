...
# Builds scatterplot canvasXpress object used across tests.
# Returns NULL (rather than failing) if the remote data files can't
...
# ---------------------------------------------------------------------------
# End-to-end behavior (widget and pandoc render)
# ---------------------------------------------------------------------------
...
# only rmarkdown::render is mocked, to
