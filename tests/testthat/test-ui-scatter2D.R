...
test_that("cXscatter2d4", {
    ...
    message("Some legends boxes may not be visible if plot is not resized due to space allotted - working as designed")
})
...
test_that("cXscatter2d15", {
    check_ui_test(cXscatter2d15())
})

test_that("cXscatter2d16", {
    check_ui_test(cXscatter2d16())
})

test_that("cXscatter2d17", {
    check_ui_test(cXscatter2d17())
})
