...
cXmap1 <- function() {
  ...
  canvasXpress(
    ...
    leafletId="world",
    topoJSON=list(world50m="http://www.canvasxpress.org/json/world-50m.json")
  )
}
...
cXmap3 <- function() {
  ...
  canvasXpress(
    ...
    leafletId="states",
    showLegend=FALSE,
    topoJSON=list(states="http://www.canvasxpress.org/json/usa-states.json")
  )
}
...
cXmap4 <- function() {
  ...
  canvasXpress(
    ...
    leafletId="counties",
    topoJSON=list(counties="http://www.canvasxpress.org/json/usa-counties.json")
  )
}
...
cXmap5 <- function() {
  ...
  canvasXpress(
    ...
    leafletConfig=list(attributionControl=FALSE, center=list(38, -95), zoom=4),
    leafletId="districts",
    topoJSON=list(districts="http://www.canvasxpress.org/json/usa-districts.json")
  )
}
...
cXnetwork2 <- function() {
  library(canvasXpress)
  nodes=read.table(system.file("extdata", "cX-lesmiserableBH-nodes.txt.gz", package = "canvasXpress"), header=TRUE, sep="\t", quote="", fill=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
  edges=read.table(system.file("extdata", "cX-lesmiserableBH-edges.txt.gz", package = "canvasXpress"), header=TRUE, sep="\t", quote="", fill=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
  canvasXpress(
    nodeData=nodes,
    edgeData=edges,
    colorNodeBy="group",
...
cXnetwork3 <- function() {
  library(canvasXpress)
  nodes=read.table(system.file("extdata", "cX-lesmiserableC-nodes.txt.gz", package = "canvasXpress"), header=TRUE, sep="\t", quote="", fill=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
  edges=read.table(system.file("extdata", "cX-lesmiserableC-edges.txt.gz", package = "canvasXpress"), header=TRUE, sep="\t", quote="", fill=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
  canvasXpress(
    nodeData=nodes,
    edgeData=edges,
    colorNodeBy="group",
...
cXnetwork9 <- function() {
  library(canvasXpress)
  canvasXpress(
    data="http://www.canvasxpress.org/debug/hsa05222.xml",
    appendNetworkData=list("http://www.canvasxpress.org/debug/hsa05222.txt", list(data=list("2"=list(Exp5=-3, Exp6=4, Exp7="H", Exp8=list(CL1=2, CL2=14, CL3=7), Exp9=list(CL1=32, CL2=1, CL3=5)), "3"=list(Exp5=-1, Exp6=15, Exp7="L", Exp8=list(CL1=2, CL2=40, CL3=22), Exp9=list(CL1=45, CL2=4)), "4"=list(Exp5=5, Exp6=40, Exp7="H", Exp8=list(CL1=32, CL2=4, CL3=15), Exp9=list(CL1=52, CL2=4)), "8"=list(Exp5=10, Exp6=24, Exp7="H", Exp8=list(CL1=12, CL2=4, CL3=1), Exp9=list(CL1=21, CL2=44, CL3=9)), "9"=list(Exp5=-8, Exp6=14, Exp7="M", Exp8=list(CL1=2, CL2=14, CL3=32), Exp9=list(CL1=12, CL2=4))), type="node")),
    colorNodeBy="Exp1",
    graphType="Network"
  )
}
...
cXnetwork11 <- function() {
  library(canvasXpress)
  canvasXpress(
    data="http://www.canvasxpress.org/debug/WP3624_95209.gpml",
    graphType="Network"
  )
}
...
cXnetwork12 <- function() {
  library(canvasXpress)
  canvasXpress(
    data="http://www.canvasxpress.org/debug/example.xgmml",
    graphType="Network"
  )
}
...
cXnetwork13 <- function() {
  library(canvasXpress)
  canvasXpress(
    data="http://www.canvasxpress.org/debug/Apoptosis.xml",
    graphType="Network"
  )
}
